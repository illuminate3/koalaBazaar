            ...
            <div class="container clearfix">
                ...
                <nav id="primary-menu">
                    ...
                    <ul>
                        ...
                        <li class="mega-menu current"><a href="#"><div>Pages</div></a>
            ...
            <div class="container clearfix">
                ...
                <div class="col_two_third col_last nobottommargin">
                    ...
                    <div class="accordion accordion-lg divcenter nobottommargin clearfix" style="max-width: 550px;">
                        ...
                        <div class="acctitle">
                            <i class="acc-open icon-user4"></i>Müşteri misiniz?</div>
                ...
                <span class="input-group-addon input-circle-left">
                    <i class="fa fa-user"></i>
                                        ...
                                        <input class="form-control placeholder-no-fix input-circle-right" type="text" autocomplete="off"  placeholder="Username" name="username">
                                    </div>
                                </div>
                ...
                <span class="input-group-addon input-circle-left">
                    <i class="fa fa-lock"></i>
                                        ...
                                        <input class="form-control placeholder-no-fix input-circle-right" type="password" autocomplete="off" id="register_password" placeholder="Password" name="password">
                                    </div>
                                </div>
                ...
                <span class="input-group-addon input-circle-left">
                    <i class="fa fa-lock"></i>
                                        ...
                                        <input class="form-control placeholder-no-fix input-circle-right" type="password" autocomplete="off" id="register_password" placeholder="Re-type your password" name="rpassword">
                                    </div>
                                </div>
                ...
                <span class="input-group-addon input-circle-left">
                    <i class="fa fa-font"></i>
                                ...
                                <div class="col_full nobottommargin">
                                    <button class="button button-3d button-green" id="login-form-submit" name="login-form-submit" value="login">Sign Up</button>
                                    <button class="button button-3d button-blue" id="login-form-submit" name="login-with-instagram"  >Login with Instagram</button>
                                    <a href="#" class="fright">Forgot Password?</a>
                                </div>
                            </form>
                        </div>

                        <div class="acctitle"><i class="acc-closed icon-user4"></i><i class="acc-open icon-ok-sign"></i>Mağaza mısınız?</div>
                        <div class="acc_content clearfix">
                            <a href="{{ action('AuthenticationController@registersupplierviainstagram') }}" class="button button-3d button-blue nomargin" name="register-form-submit">Instagram ile kayıt ol</a>
