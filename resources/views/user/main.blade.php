...
<div id="wrapper" class="clearfix">
                        ...
                        <li>
                            ...
                            <div class="top-link-section">
                                <form id="top-login" role="form" action="{{ action('AuthenticationController@doLogin')}}" method="post">
                                    ...
                                    <a href="{{ action('AuthenticationController@loginviainstagram') }}" class="btn btn-primary btn-block" name="login-with-instagram">Instagram
                                    </a>
    ...
    <header id="header" class="sticky-style-2">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="{{asset('/user')}}/images/logo-dark.png"><img src="{{asset('/user')}}/images/logo.png" alt="Canvas Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="{{asset('/user')}}/images/logo-dark@2x.png"><img src="{{asset('/user')}}/images/logo@2x.png" alt="Canvas Logo"></a>
            </div><!-- #logo end -->
