        ...
        <div id="top-bar">
            ...
            <div class="container clearfix">
                ...
                <div class="col_half nobottommargin hidden-xs">
                    ...
                    <p class="nobottommargin"><strong>Call:</strong> 1800-547-2145 | <strong>Email:</strong> info@canvas
                        .com</p>
                ...
                <div class="col_half col_last fright nobottommargin">
                    ...
                    <div class="top-links">
                        <ul>
                            ...
                            <li><a href="#">EN</a>
                                <ul>
                                    <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/french.png"
                                                         alt="French"> FR</a></li>
                                    <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/italian.png"
                                                         alt="Italian"> IT</a></li>
                                    <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/german.png"
                                                         alt="German"> DE</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Login</a>
