...
<div id="wrapper" class="clearfix">
            ...
            <div class="col_half col_last fright nobottommargin">
                ...
                <div class="top-links">
                    <ul>
                        ...
                        <li><a href="#">EN</a>
                            <ul>
                                <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/french.png" alt="French"> FR</a></li>
                                <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/italian.png" alt="Italian"> IT</a></li>
                                <li><a href="#"><img src="{{asset('/user')}}/images/icons/flags/german.png" alt="German"> DE</a></li>
                            </ul>
                        </li>
                        <li><a href="#">Login</a>
    ...
    <header id="header" class="sticky-style-2">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="{{asset('/user')}}/images/logo.png" alt="Canvas Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="{{asset('/user')}}/images/logo@2x.png" alt="Canvas Logo"></a>
            </div><!-- #logo end -->
                            ...
                            <div class="top-cart-items">
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="{{asset('/user')}}/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
                                    </div>
                                ...
                                <div class="top-cart-item clearfix">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="{{asset('/user')}}/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
                                    </div>
                                    <div class="top-cart-item-desc">
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div id="oc-clients-full" class="owl-carousel image-carousel">
                    ...
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/1.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/2.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/3.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/4.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/5.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/6.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/7.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/8.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/9.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/10.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/11.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/12.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/13.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/14.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/15.png" alt="Clients"></a></div>
                    <div class="oc-item"><a href="#"><img src="{{asset('/user')}}/images/clients/logo/18.png" alt="Clients"></a></div>
                ...
                <div class="col_two_third">
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="widget clearfix">
                            ...
                            <img src="{{asset('/user')}}/images/footer-widget-logo.png" alt="" class="footer-logo">
